...
const Hero = () => {
  return (
    <>
      <div className="text-black lg:px-24 py-28 grid grid-cols-1 md:grid-cols-2 content-center justify-items-center gap-y-10 bg-gray-100 min-h-full">
        <div className="grid grid-cols-1 text-left gap-y-10">
          ...
          <button className="w-2/4 transition ease-in-out delay-150 bg-red-500 hover:-translate-y-1 hover:scale-110 hover:bg-red-600 duration-300 px-5 py-2">
            Contact Us
          </button>
        </div>
